...
<!-- box: the working variable: | impurity ℓ = 1 − Tr ρ² -->
...
<!-- box: the score: rank by ℓ | (entropy is a monotone relabel) -->
...
<!-- box: dρ = kD[M]dt + √k H[M]dW | dy = ⟨M⟩dt + dW/(2√k) -->
...
<!-- box: dℓ increment: drift ≤ 0, | noise ∝ cos θ -->
...
<!-- box: steer ⊥: ℓ = ℓ₀e^{−4kt} | on every record -->
...
<!-- box: deadline and race rank | the protocols oppositely -->
...
<!-- box: a drive is absorbed | by the re-aiming -->
...
<!-- box: η < 1: floor (1−η)/2; | verdict reverses -->
...
<!-- box: cap exactly when the unwatched | attractor is mixed -->
