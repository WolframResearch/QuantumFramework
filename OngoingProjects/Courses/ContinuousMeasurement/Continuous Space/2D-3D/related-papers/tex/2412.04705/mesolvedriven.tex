...
fit_times = np.linspace(0, 25, 1000)  # range for correlation function fit
...
exp_bath, fit_info = bath.approximate("cf",fit_times, Ni_max=1, Nr_max=3, target_rmse=None)
...
exp_bath, fit_info = bath.approximate("cf",fit_times, Ni_max=1, Nr_max=2, target_rmse=None)
print(fit_info['summary'])
