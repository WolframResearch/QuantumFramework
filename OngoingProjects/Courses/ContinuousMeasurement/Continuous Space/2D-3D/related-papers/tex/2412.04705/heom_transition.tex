...
for i in range(len(alphas)):
    ...
    cfit, fitinfo = env.approximate(
       "cf", tlist=t, Ni_max=1, Nr_max=2, target_rmse=None, full_ansatz=True, maxfev=int(1e9)
    )
    ...
    HEOMMats = HEOMSolver(Hsys, (cfit, Q), NC, options=options)
