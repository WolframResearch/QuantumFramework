...
user_env_sd, _ = user_env.approximate("sd",wlist=w, Nk=3, Nmax=3)

user_env_cf, _ = user_env.approximate("cf",tlist=t, Ni_max=5, Nr_max=4, target_rmse=None, maxfev=int(1e9))
...
full = oh.spectral_density(w)
axfit[0].plot(w, full, color=colors[0], label="Original")
j = 1
markers = ["-.", "--", "-."]
for i in [1, 10, 15]:
    bath_fs, fitinfo = oh.approximate("sd",wlist=w, Nmax=3, Nk=i)
