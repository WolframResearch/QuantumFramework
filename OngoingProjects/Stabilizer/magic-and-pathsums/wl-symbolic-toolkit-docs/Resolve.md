...
```wolfram
Graphics[{{LightRed,EdgeForm[Gray],𝒮},{StandardBlue,EdgeForm[Gray],ℛ}}]
```
...
```wolfram
Graphics3D[{{Opacity[0.3],𝒮},{StandardBlue,EdgeForm[Gray],ℛ}}]
```
...
```wolfram
Graphics[{{StandardBlue,EdgeForm[Gray],𝒮},{ℛ}}]
```
...
## Tech Notes ▪Quantifiers ▪Complex Polynomial Systems ▪Implementation notes: Algebra and Calculus
