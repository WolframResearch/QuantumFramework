...
>
> - **Current API**: [`api.md`](api.md)
> - **What works today (verification)**: [`Tests/Stabilizer/`](../../../Tests/Stabilizer/) (the `synthesis-implementation.md` capability tour was retired 2026-05-07, superseded by the test suite)
> - **Open items + design rationale**: [`roadmap.md`](roadmap.md)
> - **Round-trip miss post-mortem**: [`postmortem.md`](postmortem.md)
