...
- `../literature/External Packages/QuantumClifford.jl` — pure-Julia, Krastanov / QuantumSavory.
- `../literature/External Packages/Stim` — Google Quantum AI / Gidney, C++ with pybind11.
