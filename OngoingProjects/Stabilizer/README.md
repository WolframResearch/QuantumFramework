...
| 2 | **Performance rework** | Bit-packed gates + a Compile-to-C generator-major gate fold; packed measurement; exact-rational Mallows sampler. | **Shipped to kernel.** 266-1095x speedups; beats QuantumClifford.jl at $n=1000$. Phase-resolved vs Stim (2026-07-20): kernel within 4-7x of the scalar build, end-to-end 11-16x with fast I/O, boundary-dependent either way (two earlier single-ratio figures were both wrong, in opposite directions). Full report lives in `../Platform Comparison/`. |
