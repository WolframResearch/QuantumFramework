...
(* Phase 8.3 (2026-05-06): AG phase tracking + contraction-sign correction.    *)
(*                                                                              *)
...
(* ============================================================================ *)
(* Phase 8.3 helper: AG phase tracking when XOR-summing tableau rows.          *)
(*                                                                              *)
...
(* ============================================================================ *)
(* Phase 8.3 helper: |Phi+>_BB' contraction sign for combined B Pauli.         *)
(*                                                                              *)
...
cc1_CliffordChannel[cc2_CliffordChannel] /; CliffordChannelQ[cc1] && CliffordChannelQ[cc2] := Module[{
    ...
    (* compute the composition row with full Phase 8.3 phase tracking:        *)
